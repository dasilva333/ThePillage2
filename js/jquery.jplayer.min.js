...
*/
		...
		_init: function() {
			...
			this.isWebOS = "palmGetResource" in window;
			if(this.require.audio) { // If a supplied format is audio
				this.htmlElement.audio = this.isWebOS ? window.audioPlayer : document.createElement('audio');
				this.htmlElement.audio.id = this.internal.audio.id;
				this.html.audio.available = this.isWebOS || (!!this.htmlElement.audio.canPlayType && this._testCanPlayType(this.htmlElement.audio)); // Test is for IE9 on Win Server 2008.
			}
			...
			this.flash.canPlay = {};
			$.each(this.formats, function(priority, format) {
				self.html.canPlay[format] = self.isWebOS || (self.html[self.format[format].media].available && "" !== self.htmlElement[self.format[format].media].canPlayType(self.format[format].codec));
