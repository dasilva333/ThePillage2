(function() {
  ...
  App.Models.Tracks = (function() {
    ...
    function Tracks(options) {
      this.success = __bind(this.success, this);      Tracks.__super__.constructor.apply(this, arguments);
      this.reset();
    ...
    Tracks.prototype.success = function(data) {
